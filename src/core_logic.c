...
void AES256_Encrypt(uint8_t *input, uint8_t *output, uint8_t *roundKeys) {
    state_t state;
...
int main() {
    uint8_t key[32] = {
        ...
        0x18,0x19,0x1A,0x1B,0x1C,0x1D,0x1E,0x11
    };

    uint8_t roundKeys[240];
    uint8_t plaintext[16]  = "HelloAES256Test";
    uint8_t ciphertext[16];

    KeyExpansion(key, roundKeys);
    AES256_Encrypt(plaintext, ciphertext, roundKeys);
